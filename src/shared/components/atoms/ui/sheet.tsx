  ...
  return (
    <SheetPortal>
      ...
      >
        ...
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring bg-destructive hover:bg-destructive/90 absolute top-4 right-4 cursor-pointer rounded-full p-2 transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
